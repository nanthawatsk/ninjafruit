...
class Assets:
    def __init__(self):
        self.fruits = {
            "watermelon": {
                "whole": load_image('watermelon.png', CONFIG["fruit_sizes"]["watermelon"]),
                "left": load_image('watermelon_left.png', CONFIG["fruit_sizes"]["watermelon"]),
                "right": load_image('watermelon_right.png', CONFIG["fruit_sizes"]["watermelon"]),
                "stain": load_image('stain_watermelon.png')
            },
            "pineapple": {
                "whole": load_image('pineapple.png', CONFIG["fruit_sizes"]["pineapple"]),
                "left": load_image('pineapple_left.png', CONFIG["fruit_sizes"]["pineapple"]),
                "right": load_image('pineapple_right.png', CONFIG["fruit_sizes"]["pineapple"]),
                "stain": load_image('stain_pineapple.png')
            },
            "orange": {
                "whole": load_image('orange.png', CONFIG["fruit_sizes"]["orange"]),
                "left": load_image('orange_left.png', CONFIG["fruit_sizes"]["orange"]),
                "right": load_image('orange_right.png', CONFIG["fruit_sizes"]["orange"]),
                "stain": load_image('stain_orange.png')
            },
            "banana": {
                "whole": load_image('banana.png', CONFIG["fruit_sizes"]["banana"]),
                "left": load_image('banana_left.png', CONFIG["fruit_sizes"]["banana"]),
                "right": load_image('banana_right.png', CONFIG["fruit_sizes"]["banana"]),
                "stain": load_image('stain_banana.png')
            }
        }
        self.bomb = load_image('bomb.png', CONFIG["fruit_sizes"]["bomb"])
        
        self.sounds = {
            "slice": load_sound('slice.mp3'),
            "bomb": load_sound('explosion.mp3'),
            "level_up": load_sound('level_up.mp3')
        }
